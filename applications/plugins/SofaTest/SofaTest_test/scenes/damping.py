...
def createScene(node):
    ...
    angularNode.createObject('NodalLinearDampingForceField', dampingCoefficients=[DAMPING_COEF]*6)
    ...
    translationNode.createObject('NodalLinearDampingForceField', dampingCoefficients=[DAMPING_COEF]*6)
