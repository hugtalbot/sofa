...
#ifndef SOFA_COMPONENT_LIGHTMANAGERPASS_H
#define SOFA_COMPONENT_LIGHTMANAGERPASS_H
#include "config.h"
...
class SOFA_OPENGL_VISUAL_API LightManagerPass : public component::visualmodel::VisualManagerPass
{
public:
    SOFA_CLASS(LightManagerPass, component::visualmodel::VisualManagerPass);
...
#endif //SOFA_COMPONENT_LIGHT_MANAGER_PASS_H
