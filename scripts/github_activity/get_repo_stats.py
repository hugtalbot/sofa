...
for repo in repos:
  ...
  postOnDiscord("-------------------------")
  postOnDiscord(str(discussions)+" discussion topics")
  postOnDiscord(str(answers_count)+" answered")
  postOnDiscord(str(replies_count)+" replies")
  postOnDiscord(str(recent_discussions_authors)+" recent discussion authors")
  postOnDiscord("-------------------------")
  postOnDiscord(str(issues_count)+" issues")
  postOnDiscord(str(closed_count)+" closed")
  postOnDiscord(str(recent_issues_authors)+" recent issue authors")
  postOnDiscord("-------------------------")
  postOnDiscord(str(pulls_count)+" PRs")
  postOnDiscord(str(openPR_count)+" open")
  postOnDiscord(str(merged_count)+" merged")
  # print(recent_pulls_count, "nb recent PRs")
  postOnDiscord(str(recent_pulls_authors)+" recent PR authors")
  postOnDiscord(str(pulls_first_timer_count)+" nb pull 1st timers")
  postOnDiscord(str(pulls_first_timers)+" 1st timers")
  postOnDiscord("=========================\n\n")
